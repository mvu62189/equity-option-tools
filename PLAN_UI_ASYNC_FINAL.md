...
3. Bound memory growth for 1–3 symbols over long sessions.
4. Keep data persistence reliable while avoiding tiny-file explosion.

### SLOs
1. UI apply+render latency: `p95 < 50ms`.
2. Process memory guardrail for 1–3 symbols: `< 1.5 GB` steady-state RSS.
...
3. Memory: RSS stays `< 1.5 GB` in 1–3 symbol profile after warmup.
...
4. Symbol target profile remains 1–3 symbols.
